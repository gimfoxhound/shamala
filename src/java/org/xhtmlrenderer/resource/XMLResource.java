    ...
    public static final  XMLReader newXMLReader() {
        ...
        if (xmlReader == null) {
            /*throw new XRRuntimeException("Could not instantiate any SAX 2 parser, including JDK default. " +
                    "The name of the class to use should have been read from the org.xml.sax.driver System " + "property, which is set to: "/*CHECK: is this meaningful? + System.getProperty("org.xml.sax.driver"));*/
                            //throw new Exception();
                            System.err.println("ligne 158"+XMLResource.class.getName());
        }
